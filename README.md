...
- Published on the standalone `main` branch.
- Generic HAL source is byte-identical to the validated Perseus and Starter integrations.
- Hardware integration is available in `dspic33ak-hal-starter`.
